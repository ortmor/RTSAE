    ...
    <div className={Styles.innersolutionfooterlandingheadingparent}>
      <div className={Styles.innersolutionfooterlandingparentmain}>
        <div className={Styles.innersolutionfooterlandingparenthead}>
          <h1>Elevate Your Space with PA-BGM Systems</h1>
        </div>

        <div className={Styles.innersolutionfooterlandingparentheadparagraph}>
          <p>
            PA-BGM systems, offer a seamless integration of audio
            functionalities that can transform your space. Whether it's a hotel
            lobby lounge or a public space, our expert engineers at RTS
            specialize in designing and implementing PA-BGM systems that elevate
