    ...
    <div className={Styles.landingheadingparent}>
      <div className={Styles.landingparentmain}>
        <div className={Styles.landingparenthead}>
          <h1>Unleashing the Power of Sound Expertly Crafted</h1>
          <h1> PA-BGM Systems for Diverse Open Spaces</h1>
        </div>

        <div className={Styles.landingparentheadparagraph}>
          <p>
            At RTS, we recognize the profound impact that speech and music have
            on the human mind, influencing critical decision-making processes
            and providing entertainment. That's why our team of skilled
            engineers is dedicated to designing top-of-the-line PA-BGM (Public
          ...
          <p>
            ...
            communication, and overall experience within diverse open spaces,
            enriching the lives of individuals and communities alike. Our
