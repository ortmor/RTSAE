      ...
      <div className={Styles.landingparentmain}>
        ...
        <div className={Styles.landingparentheadparagraph}>
          <p>
            ...
            changing needs of the company and its personnel. RTS empowers you to
            manage, maintain, & operate our established system with efficiency
            and ease of use to allow for a faster shift to digital development.
            Our innovative and industry-leading approaches have consistently
            been delivered without failure.
          </p>
