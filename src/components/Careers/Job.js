    ...
    <div className={Styles.careersmanagedserviceshome}>
      <div className={Styles.careersmanagedservicesparent}>
        <div className={Styles.careersmanagedservicesbox}>
          <Link href="/jobs/AM.jpg" target="_blank">
        ...
        <div className={Styles.careersmanagedservicesbox}>
          <Link href="/jobs/RTSJob0723.png" target="_blank">
            <div className={Styles.careersmanagedservicescontentmain}>
              <div className={Styles.careersmanagedservicescontentmainboxmain}>
                <div
                  className={
        ...
        <div className={Styles.careersmanagedservicesbox}>
          <Link href="/jobs/ps.jpg" target="_blank">
            <div className={Styles.careersmanagedservicescontentmain}>
              <div className={Styles.careersmanagedservicescontentmainboxmain}>
                <div
                  className={
        ...
        <div className={Styles.careersmanagedservicesbox}>
          <Link href="/jobs/RTSJob0723a.png" target="_blank">
            <div className={Styles.careersmanagedservicescontentmain}>
              <div className={Styles.careersmanagedservicescontentmainboxmain}>
                <div
                  className={
        ...
        <div className={Styles.careersmanagedservicesbox}>
          <Link href="/jobs/nse.png" target="_blank">
            <div className={Styles.careersmanagedservicescontentmain}>
              <div className={Styles.careersmanagedservicescontentmainboxmain}>
                <div
                  className={
        ...
        <div className={Styles.careersmanagedservicesbox}>
          <Link href="/jobs/AVE.png" target="_blank">
            <div className={Styles.careersmanagedservicescontentmain}>
              <div className={Styles.careersmanagedservicescontentmainboxmain}>
                <div
                  className={
