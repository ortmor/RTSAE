      ...
      <div className={Styles.innersolutionfooterlandingparentmain}>
        ...
        <div className={Styles.innersolutionfooterlandingparentheadparagraph}>
          <p>
            ...
            systems, and intercoms. ELV - Physical Security Solutions are
            designed to enhance the safety and protection of individuals,
            properties, and assets. By utilizing low-voltage power, these
            solutions offer efficient and reliable security measures while
            minimizing risks associated with high-voltage installations.
          </p>
          <br />
        </div>
      </div>
