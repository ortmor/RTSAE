    ...
    <div className={Styles.innersolutionfooterlandingheadingparent}>
      <div className={Styles.innersolutionfooterlandingparentmain}>
        ...
        <div className={Styles.innersolutionfooterlandingparentheadparagraph}>
          <p>
            Control systems serve as the foundation for efficient and successful
            businesses, revolutionizing the management of operations by offering
            real-time monitoring, automation, and streamlined control over
            critical processes. At RTS, we specialize in providing advanced
          ...
          <p>
            ...
            specific needs and align with industry requirements. Our team of
            experienced professionals works closely with clients to assess their
